...
ALLOWED_HOSTS = ['127.0.0.1', 'localhost', 'djangorestaurantbackend.onrender.com']
...
INSTALLED_APPS = [
    ...
    'reservations',    # Add your custom app for the reservation system
    'corsheaders',     # Add this for handling cross-origin requests
]
